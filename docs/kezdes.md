...
| Fájl | Használat |
| --- | --- |
| `README.md` | Az adott mappa útmutatója; GitHubon olvasható |
| `.py` | Python-program; futtatásához kövesd a [Python-segédletet](python/README.md) |
| `.nb` | Mathematica-notebook; nyisd meg a [Mathematicában](mathematica/README.md) |
| `requirements.txt` | A Python-példák csomaglistája |

A programokat a kicsomagolt mappából indítsd. Windowsban jelenítsd meg a fájlnévkiterjesztéseket, hogy például a `.py` fájl ne legyen véletlenül `.py.txt`.
